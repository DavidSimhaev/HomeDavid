...
l = [ Thread(target=func, args=(x,1)) for x in range(1,10) ]
l1 = [ Thread(target=func, args=(x,2)) for x in range(11,20) ] 
l2 = [ Thread(target=func, args=(x,3)) for x in range(21,30) ]
