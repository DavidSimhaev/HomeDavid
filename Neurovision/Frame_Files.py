...
class Files:
    ...
    def load_frame(self, files):
        ...
        self.c = True
        self.list_files_from_pr(self.new_frame)
    ...
    def list_files_from_pr(self, New_Frame_Files):
                        ...
                        if answer:
                            ...
                            for el in str(file_pr["elem"]["textvariable"])[::-1]:
                                ...
                                if el == "/": 
                                    ...
                                    clone_v = clone(New_Frame_Files)
                                    print(clone_v)
                                    w.destroy()
                                    
                                    
                                    Frame_Files = tk.LabelFrame(New_Frame_Files ,text = "Files", fg="#6666ff",font = "Arial 12 bold ", width= 340, height= 235, bg= "#CCCCFF")                #
