...
def main(page: Page):
    ...
    button_add = IconButton(fl.icons.ADD, on_click= add_click, icon_size= 40, icon_color=fl.colors.GREEN)
    button_remove = IconButton(fl.icons.REMOVE, on_click= remove_click, icon_size= 40, icon_color=fl.colors.RED)
